...
export default function Products() {
  ...
  const [productSalesType, setProductSalesType] = useState<"wholesale" | "retail">("retail");
  ...
  }, [productName, productDescription, productPrice, productInStock, productCategory, productSalesType, products]);
  ...
  }, [selectedProductId, productName, productDescription, productPrice, productInStock, productCategory, productSalesType, products]);
  ...
  const handleDeleteProduct = useCallback(async () => {
    ...
    try {
      ...
      if (response.ok) {
        // Remove the deleted product from the local state (frontend)
        setProducts(products.filter((p) => p.id !== productToDelete.id));
        
        // Close the delete confirmation modal and reset the selected product to delete
        setIsDeleteConfirmationOpen(false);
        setProductToDelete(null);
      } else {
        console.error("Failed to delete product, response not ok");
      }
    } catch (error) {
  ...
  console.log("Running filter with:", filters);
  ...
  setFilters((prevFilters) => {
    ...
    console.log("New Filters:", newFilters); // ✅ log here
    return newFilters;
  });
  setCurrentPage(1);
};
            ...
            <div className="flex items-center gap-4">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-48">
                  ...
                  <DropdownMenuCheckboxItem
                    checked={filters.category === "dog-food"}
                    onCheckedChange={() =>
                      handleFilterChange("category", "dog-food")
                    }
                  >
                    Dog Food
                  </DropdownMenuCheckboxItem>
                  <DropdownMenuCheckboxItem
                    checked={filters.category === "cat-food"}
                    onCheckedChange={() =>
                      handleFilterChange("category", "cat-food")
                    }
                  >
                    Cat Food
                  </DropdownMenuCheckboxItem>
    ...
    currentProducts.map((product) => (
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              onClick={() => {
                ...
                setProductSalesType(product.sales_type as "wholesale" | "retail");
      ...
      >
        <DialogContent>
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="sales_type" className="text-right">
              Sales Type
            </Label>
            <Select
              value={productSalesType}
              onValueChange={(value) =>
                setProductSalesType(value as "wholesale" | "retail")
              }
            >
              <SelectTrigger className="col-span-3">
